...
void saveresult(cv::Mat& cvt_img, cv::Mat& seg_res, std::vector<Yolo::Detection>& res)
{
...
int main(int argc, char** argv) {
    ...
    std::cout << "number of bindings: " << engine->getNbBindings() << "\n";
    ...
    doInferenceCpu(*context, stream, buffers, data, det_out, seg_out, nullptr, BATCH_SIZE);
    // cuCtxPopCurrent(&ctx);
    ...
    saveresult(img, seg_res, batch_res);
    // destroy windows
#ifdef SHOW_IMG
