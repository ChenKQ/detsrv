...
static const char CALIB_DIR[] = "/home/nvidia/data/ship";
...
ICudaEngine* build_engine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt, float& gd, float& gw, std::string& wts_name) {
    ...
    Int8EntropyCalibrator2* calibrator = new Int8EntropyCalibrator2(1, INPUT_W, INPUT_H, CALIB_DIR, "int8calib.table", INPUT_BLOB_NAME);
